...
##    Plot 2: Output file as a png            
##    as plot2.png in the working directory   

png(file = "plot2.png", bg = 'transparent') 
plot(powerDataSubset$Timestamp, powerDataSubset$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")
dev.off()
